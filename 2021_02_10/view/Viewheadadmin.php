        ...
        <nav>
            <div id="menu">
                ...
                <ul>
                    ...
                    <?php
                    echo '<li id="bonjour">Bonjour ' . $_SESSION['user'] . '</li>';
                    echo '<li><a href="index.php?action=deconnect">Deconnexion</a></li>';
                    ?>
                </ul>
            </div>

            <div id="titreadmin">
                <h1 id="titresite">Billet simple pour l'Alaska</h1>
                <h2 id="soustitre">Espace administrateur</h2>
